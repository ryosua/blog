...
_Edit (11/12/17): I still have not been able to create an account on Steemit to try it out. It seems like they are giving new users some Steem when they join the platform, so they have to manually verify new accounts so that people don't abuse this. I have reached out to their support team, so might be able to get in soon to check it out._
